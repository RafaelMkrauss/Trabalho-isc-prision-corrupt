...
CHAR_POS:	.half 64,192	# x, y
OLD_CHAR_POS:	.half 64,192	

.text
CHEAT1:

		la a0,floorCompleted			# carrega o endereco do sprite 'map' em a0
		li a1,0				# x = 0
		li a2,0				# y = 0
		li a3,0				# frame = 0
...
CHEAT2:
		...
		la a0,score00			# carrega o endereco do sprite 'map' em a0
		li a1,0				# x = 0
		li a2,0				# y = 0
		li a3,0				# frame = 0
		call PRINT			# imprime o sprite
